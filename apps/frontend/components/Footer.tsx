			...
			<div className="container mx-auto px-4 sm:px-6 lg:px-8 py-10 sm:py-12">
				<div className="grid grid-cols-1 md:grid-cols-4 gap-8">
					...
					<div>
						...
						<ul className="space-y-2 text-sm text-muted-foreground">
							<li>
								<Link href="/shop/ghee" className="hover:text-primary">
									Ghee
								</Link>
							</li>
							<li>
								<Link href="/shop/pickles" className="hover:text-primary">
									Pickles
								</Link>
							</li>
							<li>
								<Link href="/shop/sweets" className="hover:text-primary">
									Sweets
								</Link>
							</li>
							<li>
								<Link href="/shop/honey" className="hover:text-primary">
									Honey
								</Link>
							</li>
						</ul>
