...
export const products: Product[] = [
  // Ghee
  {
    ...
    name: "Desi Cow Ghee",
    category: "ghee",
    description: "Pure A2 desi cow ghee made using the traditional bilona method. Rich aroma and golden texture.",
  ...
  },
  {
    ...
    name: "Buffalo Ghee",
    category: "ghee",
    description: "Creamy buffalo ghee with a rich, buttery flavor. Perfect for sweets and everyday cooking.",
  ...
  // Sweets
  {
    ...
    name: "Mysore Pak",
    category: "sweets",
    description: "Melt-in-your-mouth Mysore Pak made with pure ghee and gram flour. A South Indian classic.",
  ...
  },
  {
    ...
    name: "Boondi Laddu",
    category: "sweets",
    description: "Traditional boondi laddus made with farm-fresh ghee and aromatic cardamom.",
  ...
  // Pickles
  {
    ...
    name: "Mango Pickle",
    category: "pickles",
    description: "Tangy and spicy raw mango pickle made with cold-pressed oil and traditional spices.",
  ...
  },
  {
    ...
    name: "Lemon Pickle",
    category: "pickles",
    description: "Zesty lemon pickle with a perfect balance of sour, spicy and savory flavors.",
  ...
  },
  {
    ...
    name: "Ginger Pickle",
    category: "pickles",
    description: "Crunchy ginger pickle, a unique and flavorful addition to any meal.",
    ingredients: "Ginger, Groundnut Oil, Red Chilli, Fenugreek, Salt",
    shelfLife: "10 months",
    images: ["/placeholder.svg"],
    variants: [
      { weight: "250g", actualPrice: 220, sellingPrice: 189 },
    ],
    featured: false,
  },
  // Powders
  {
    ...
    name: "Sambar Powder",
    category: "powders",
    description: "Aromatic sambar powder ground fresh from whole spices. Makes every sambar special.",
  ...
  },
  {
    ...
    name: "Rasam Powder",
    category: "powders",
    description: "Traditional rasam powder with a robust, peppery flavor. Perfect comfort food essential.",
  ...
  // Honey
  {
    ...
    category: "honey",
    description: "Raw unprocessed wildflower honey harvested from our farm apiaries. Packed with natural enzymes.",
  ...
  // Oils
  {
    ...
    category: "oils",
    description: "Traditional wood-pressed groundnut oil with rich nutty aroma. Zero chemicals.",
  ...
  },
  {
    ...
    category: "oils",
    description: "Pure virgin coconut oil extracted from farm-fresh coconuts. Great for cooking and skin.",
  ...
  // Snacks
  {
    ...
    name: "Rice Murukku",
    category: "snacks",
    description: "Crispy spiral murukku made with rice flour and cumin. A classic tea-time snack.",
  ...
  },
  {
    ...
    category: "snacks",
    description: "Spicy and crunchy mixture with sev, peanuts, curry leaves and a medley of dals.",
  ...
  // Rice
  {
    ...
    category: "rice",
    description: "Lightweight, aromatic Sona Masoori rice grown organically on our farm.",
  ...
  },
  {
    ...
    name: "Brown Rice",
    category: "rice",
    description: "Unpolished brown rice packed with fiber and nutrients. A healthier everyday choice.",
  ...
  // Millets
  {
    ...
    category: "millets",
    description: "Calcium-rich ragi grown naturally. Perfect for ragi mudde, porridge, and dosas.",
  ...
  },
  {
    ...
    name: "Foxtail Millet",
    category: "millets",
    description: "Nutritious foxtail millet, an excellent rice substitute for a balanced diet.",
  ...
  // Pulses
  {
    ...
    name: "Toor Dal",
    category: "pulses",
    description: "Farm-fresh toor dal with a rich taste and quick cooking time.",
  ...
  },
  {
    ...
    name: "Moong Dal",
    category: "pulses",
    description: "Clean, polished moong dal perfect for khichdi, dal tadka, and more.",
  ...
  // Cereals
  {
    ...
    category: "cereals",
    description: "A nutritious blend of 7 grains roasted and ground fresh. Great for porridge or smoothies.",
